    ...
    <Box sx={{ fontFamily: "Josefin Sans" }}>
      ...
      >
        <Container maxWidth="lg">
          <Typography
            variant="h4"
            sx={{ fontFamily: "Diphylleia", fontWeight: "bold", color: "#7f7f7f", mb: 2 }}
          >
            The Daring Lab
          </Typography>
          ...
          {/* <Typography
  variant="h6"
  sx={{ fontWeight: "bold", color: "#7f7f7f", mt: 2, mb: 2 }}
>
  Au sommaire :
</Typography> */}
...
{/* <Box sx={{ color: "#7f7f7f" }}> */}
  ...
  {/* <Typography variant="body1" gutterBottom>
    Inclusion & diversité : insight de marché
  </Typography>
  <Box component="ul" sx={{ listStyle: "disc", ml: 4 }}>
    <Box component="li">
      Pourquoi la diversité est un avantage compétitif pour les marques ?
    </Box>
    <Box component="li">
      Tendance & Insight : La Représentation Multiculturelle dans l’Industrie du Luxe
    </Box>
    <Box component="li">
  ...
  {/* <Typography variant="body1" gutterBottom sx={{ mt: 2 }}>
    Accompagnement & coaching carrière dans l’industrie du luxe et de la cosmétique
  </Typography>
  <Box component="ul" sx={{ listStyle: "disc", ml: 4 }}>
    <Box component="li">
      10 conseils pour réussir son entretien dans le secteur retail luxe
    </Box>
    <Box component="li">5 stratégies pour vous démarquer dans un marché compétitif</Box>
    <Box component="li">
...
{/* </Box> */}
      ...
      <Box sx={{ width: "100%", padding: { xs: 2, md: 8 } }}>
        <Container maxWidth="md">
          <Typography
            variant="h5"
            sx={{ fontFamily: "Diphylleia", fontWeight: "bold", color: "#7f7f7f", mb: 1 }}
          >
            Pourquoi la diversité est un avantage compétitif pour les marques ?
          </Typography>
          ...
          <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
            ...
            et des corps variés, tout en conservant son message universel autour de l’estime de soi.
          </Typography>
...
<Box sx={{ width: "100%", padding: { xs: 2, md: 8 } }}>
  <Container maxWidth="md">
    ...
    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      <strong>1. Faites vos recherches sur la marque</strong><br />
      ...
      importance particulière à leur héritage et à leur image.<br />
    ...
    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      <strong>2. Soignez votre apparence</strong><br />
      Dans le luxe, l’image compte autant que les compétences. Votre tenue doit
      refléter l’élégance et le raffinement associés à la marque.<br />
    ...
    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      <strong>3. Mettez en avant votre sens du service client</strong><br />
    ...
    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      ...
      pour la maison que vous visez.</strong><br />
    ...
    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      <strong>5. Adoptez une posture et une attitude professionnelles</strong><br />
      Votre comportement en entretien est aussi important que vos réponses.
      Politesse, élégance et assurance sont des qualités indispensables.<br />
      <em>Astuce :</em> Maintenez une posture droite, établissez un contact
      visuel et parlez avec calme et clarté.
    </Typography>

    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      <strong>6. Préparez des mises en situation</strong><br />
    ...
    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      <strong>7. Mettez en avant vos soft skills</strong><br />
    ...
    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      <strong>9. Posez des questions pertinentes</strong><br />
      Un entretien est un échange. Poser des questions montre votre intérêt et
      votre sérieux.<br />
      <em>Astuce :</em> Demandez par exemple :<br />
    ...
    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      <strong>10. Envoyez un remerciement après l’entretien</strong><br />
      Ce détail, souvent négligé, peut faire la différence. Un message de
      remerciement montre votre professionnalisme et votre motivation.<br />
...
{/* --- ARTICLE 4 : Inclusion dans la cosmétique... --- */}
<Box sx={{ width: "100%", padding: { xs: 2, md: 8 } }}>
  <Container maxWidth="md">
    <Typography
      variant="h5"
    ...
    <Typography variant="body1" paragraph sx={{ color: "#7f7f7f" }}>
      ...
      davantage de profils variés (âges, origines ethniques, morphologies, genres, etc.). 
      <br />
